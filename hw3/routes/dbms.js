...
var database = "ou27";  //database name
var user = "ou27";         //username (change to match your db)
var password = "RHFZXVWRFGW";  //password (change to match your db, yes THIS IS VERY POOR PRACTICE)
